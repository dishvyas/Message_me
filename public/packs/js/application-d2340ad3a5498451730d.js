...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ChatroomChannel", {
  ...
  received: function received(data) {
    ...
    var n = JSON.stringify(data); // console.log(data);
    ...
    document.getElementById("message-container").appendChild(node.content);
...
submit_message = function (_submit_message) {
  function submit_message() {
    return _submit_message.apply(this, arguments);
  }

  submit_message.toString = function () {
    return _submit_message.toString();
  };
...
/******/ });
//# sourceMappingURL=application-d2340ad3a5498451730d.js.map